...
private:
    ...
    int level;
    float x, y;
    double originalSpeed;  // Store original speed for reference
    double slowDuration;
...
public:
    ...
    double getOriginalSpeed() const { return originalSpeed; }
    void setSpeed(double newSpeed) { speed = newSpeed; }
    void setSlowDuration(double duration) { slowDuration = duration; }
    void updateSlowEffect(double deltaTime);
};
